  ...
  <section class="hero">
    <div class="hero__content">
      <div class="hero__container">
        <h1 class="hero__title unselectable">Amevalue —</h1>
        <!-- prettier-ignore -->
  ...
  <section class="why-choose-us">
    <div class="why-choose-us__wrapper">
      <div class="why-choose-us__content">
        ...
        <a href="#" class="why-choose-us__button">Calculate your price</a>
        <div class="why-choose-us__container unselectable">
          <div class="why-choose-us__item" tabindex="0">
            <span class="why-choose-us__item-title">Value</span>
            <!-- prettier-ignore -->
            <p class="why-choose-us__item-description">We value each and every one of our clients, so we make sure that you are satisfied and recommend us to your partners.
          </p>
          </div>

          <div class="why-choose-us__item" tabindex="0">
            <span class="why-choose-us__item-title">Price</span>
            <!-- prettier-ignore -->
            <p class="why-choose-us__item-description">Salaries in Ukraine are lower than in Europe, so you get a very motivated and experienced person almost twice as cheap.
          </p>
          </div>

          <div class="why-choose-us__item" tabindex="0">
            <span class="why-choose-us__item-title">Speed</span>
            <!-- prettier-ignore -->
            <p class="why-choose-us__item-description">Because we provide only the best services faster than most companies
            on the market.
          </p>
          </div>
