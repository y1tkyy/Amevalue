<?php 
  $contacts_block = get_field('contacts_block', 'option');
  $contacts_form  = get_field('contact_form', 'option');

  if ( $contacts_block && $contacts_form ) : 
?>
<section class="contacts" id="contacts">
  <div class="contacts__wrapper">
    <div class="contacts__content">
      ...
      <div class="contacts__info">
        ...
        <a href="<?php echo esc_url( $contacts_block['pdf_link'] ); ?>" class="contacts__info-link" target="_blank">
          <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/icons/pdf.svg' ); ?>" 
               alt="PDF icon" 
    ...
    <form class="contacts__form" data-form-action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" novalidate>
      <h2 class="contacts__form-title"><?php echo esc_html( $contacts_form['title'] ); ?></h2>
      <p class="contacts__form-text">
        <a href="mailto:business@amevalue.com">
          <?php echo esc_html( $contacts_form['sub_title'] ); ?>
        </a>
      </p>
      ...
      <input type="submit" class="contacts__form-submit" value="<?php echo esc_attr( $contacts_form['submit_button'] ); ?>" />
    </form>
  </div>
</section>
<?php endif; ?>
