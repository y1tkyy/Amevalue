...
<section class="why-choose-us">
  <div class="why-choose-us__wrapper">
    <div class="why-choose-us__content">
      <?php if (have_rows("our_customers_appreciate_us_for")): ?>
        <?php while (have_rows("our_customers_appreciate_us_for")): the_row(); ?>
          <h2 class="why-choose-us__title"><?php the_sub_field("title"); ?></h2>
...
<?php
$services_line = get_field('services_running_line');
if( $services_line ): 
?>
<section class="services" id="services">
  <div class="services__wrapper">
    <h3 class="services__title unselectable"><?php echo esc_html($services_line['title']); ?></h3>
  </div>
  <div class="services__running-line">
    <div class="services__running-line-inner">
      <span class="services__text"><?php echo esc_html($services_line['text']); ?></span>
    </div>
  </div>
</section>
<?php endif; ?>
          ...
          <?php if ($list): ?>
            ...
            ?>
              <div class="results__item">
                <p class="results__text unselectable"><?php echo wp_kses_post($text); ?></p>
              </div>
            <?php endforeach; ?>
          <?php endif; ?>
        </div>
        <?php if ($button_text): ?>
          <a href="./price" class="results__button" target="_blank"><?php echo esc_html($button_text); ?></a>
        <?php endif; ?>
      </div>
    <?php endif; ?>
    <div class="results__graph">
      <div class="results__graph-main">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/savings.svg" alt="Savings graph" class="results__graph-main-img" draggable="false" />
      </div>
      ...
      <div class="results__graph-net">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/10.svg" alt="Profit icon" class="results__graph-net-icon" draggable="false" />
        <p class="results__graph-net-text unselectable">Net profit +10%</p>
      </div>
      <div class="results__graph-rate">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/star.svg" alt="Star icon" class="results__graph-rate-icon" draggable="false" />
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/star.svg" alt="Star icon" class="results__graph-rate-icon" draggable="false" />
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/star.svg" alt="Star icon" class="results__graph-rate-icon" draggable="false" />
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/star.svg" alt="Star icon" class="results__graph-rate-icon" draggable="false" />
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/star.svg" alt="Star icon" class="results__graph-rate-icon" draggable="false" />
  ...
  <div class="trusted-us__wrapper">
    ...
    ?>
      <div class="trusted-us__content">
        <h2 class="trusted-us__title"><?php echo esc_html($title); ?></h2>
      </div>
...
<?php
$clients_line = get_field('clients_running_line');
if( $clients_line ): 
?>
<section class="clients" id="clients">
  <div class="clients__wrapper">
    <h3 class="clients__title unselectable"><?php echo esc_html($clients_line['title']); ?></h3>
  </div>
  <div class="clients__running-line">
    <div class="clients__running-line-inner">
      <span class="clients__text"><?php echo esc_html($clients_line['text']); ?></span>
    </div>
  </div>
</section>
<?php endif; ?>
